function SessionTimeOutModal() {
  ...
  this.urls = {
    ...
    logout: "/Account/SigningOut",
  };
  this.modalHtml = `
        <div class="app-modal app-modal--visible" role="dialog" aria-modal="true" id="${this.modalId}">
            <div class="app-modal__content" tabindex="0">
                ...
                <div class="app-modal__actions govuk-button-group">
                    <button class="govuk-button" id="app-timeout-action-renew">Stay signed in</button>
                    <a class="govuk-link govuk-!-margin-bottom-0" id="app-timeout-action-logout" href="#" role="button">Sign out</a>
                </div>
            </div>
        </div>`;
}
...
SessionTimeOutModal.prototype.modalEvents = function () {
  const renewButton = document.getElementById("app-timeout-action-renew");
  const logoutButton = document.getElementById("app-timeout-action-logout");
