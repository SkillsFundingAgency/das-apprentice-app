            ...
            using (new AssertionScope())
            {
                logger.Verify(x => x.Log(
                    ...
                    It.Is<It.IsAnyType>((object v, Type _) =>
                        v.ToString()!.Contains(
                            "ApprenticeId not found in user claims for Ksbs Index")),
                    It.IsAny<Exception>(),
    ...
    [Greedy] KsbController controller)
        {
            ...
            client
                .Setup(x => x.GetApprenticeshipKsbs(It.IsAny<Guid>()))
                .ReturnsAsync(new List<ApprenticeKsb>());
    ...
    ApprenticeKsb apprenticeKsb)
        {
            ...
            client
                .Setup(x => x.GetApprenticeshipKsbs(It.IsAny<Guid>()))
                .ReturnsAsync(new List<ApprenticeKsb> { apprenticeKsb });
    ...
    [Greedy] KsbController controller)
        {
            ...
            // Act
            var result = await controller.EditKsbProgress(
                ksbId,
                ksbKey,
                ksbType,
                ksbStatus,
